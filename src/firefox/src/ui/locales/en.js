...
export default {
  ...
  'st.display.cost_session_limit.desc': 'Stops cloud and OpenRouter runs before another paid model call once this session reaches the reported-cost allowance. Default $10.',
  'st.display.cost_total_limit.label': 'Cloud cost total allowance',
  'st.display.cost_total_limit.desc': 'Tracks reported cloud/OpenRouter model spend across the extension and stops further paid calls at the allowance. Local providers are not counted.',
